...
if($_COOKIE['user']==''):?>
  ...
  <p id="AccountHello2">Для просмотра диаграмм необходимо <a href ="/reg.php">зарегистрироваться</a> и <a href ="/index.php">авторизоваться</a>.</p>
<?php else:?>
  <center><h1>Диаграмма численности населения по городам</h1>
  <div class="container" style="width:900px;">

      <div id="chart1" style="height: 250px;"></div>
      <h1>Диаграмма количества населения до пенсионного возраста по возрастам</h1>
      <div id="chart2" style="height: 250px;"></div>
      <h1>Диаграмма количества населения после пенсионного возраста по возрастам</h1>
